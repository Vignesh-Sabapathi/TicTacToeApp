...
public class TicTacToeBoard extends View {
    ...
    public TicTacToeBoard(Context context, @Nullable AttributeSet attrs) {
        ...
        try{
            ...
            XColor=a.getInteger(R.styleable.TicTacToeBoard_OColor,0);
            OColor=a.getInteger(R.styleable.TicTacToeBoard_XColor,0);
            winningLineColour=a.getInteger(R.styleable.TicTacToeBoard_winningLineColor,0);
        }finally{
            a.recycle();
        }
    }
    ...
    protected  void onMeasure(int width,int height){
        ...
        int dimendion=Math.min(getMeasuredWidth(),getMeasuredHeight());
        cellSize=dimendion/3;
        setMeasuredDimension(dimendion,dimendion);
    }
